...
from App_Login.forms import SingUpForm , UserProfileChange, ProfilePic
...
def user_change(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form = UserProfileChange(instance=current_user)
            updated = True
    return render(request,'App_Login/change_profile.html',context= {'form': form,'updated':updated})
